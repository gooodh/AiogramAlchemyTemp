...
class Settings(BaseSettings):
    ...
    DB_URL: str = (
        "sqlite+aiosqlite:///data/my_data.db"  # в данном испонении sqlite не работает
    )
...
DATABASE_PG_URL = "postgresql+asyncpg://postgres_container:postgres_container@172.19.0.2:5432/postgres"
